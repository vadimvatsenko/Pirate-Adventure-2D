...
Задание: 
Создай уровень с пазлом-платформером.

Описание:
Создай уровень с пазлом-платформером размером минимум на 6 экранов (12х7 тайлов). Реализуй собственную игровую механику.
