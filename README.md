...
- [X] Самостоятельное повторение этапов лекции.
- [X] Сборка уровня с изученной на лекции механикой.
- [X] Создание партикла удара меча.
Дополнительное задание:
- [X] *. при разбитии бочки должны выпадать монетки разных типов. Настройки общего количества и вероятности выпадения каждого из типов монеток нужно вынести в инспектор.
